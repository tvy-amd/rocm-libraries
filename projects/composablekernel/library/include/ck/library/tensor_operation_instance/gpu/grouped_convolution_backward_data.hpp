        ...
        ComputeTypeB>>
{
    ...
    static auto GetInstances()
    {
        ...
        if constexpr(NumDimSpatial == 2)
        {
            ...
            //                 if constexpr(is_same_v<InDataType, F16> && is_same_v<WeiDataType,
            //                 F16> &&
            //                              is_same_v<OutDataType, F16> && is_same_v<ComputeTypeA,
            //                              F16> && is_same_v<ComputeTypeB, F16>)
            //                 {
            //                     add_device_grouped_conv2d_bwd_data_xdl_gnhwk_gkyxc_gnhwc_f16_instances(op_ptrs);
            //                 }
            // #endif
            // #ifdef CK_ENABLE_FP32
            //                 if constexpr(is_same_v<InDataType, F32> && is_same_v<WeiDataType,
            //                 F32> &&
            //                              is_same_v<OutDataType, F32> && is_same_v<ComputeTypeA,
            //                              F32> && is_same_v<ComputeTypeB, F32>)
            //                 {
            //                     add_device_grouped_conv2d_bwd_data_xdl_gnhwk_gkyxc_gnhwc_f32_instances(op_ptrs);
            //                 }
            // #endif
            // #ifdef CK_ENABLE_BF16
            //                 if constexpr(is_same_v<InDataType, BF16> && is_same_v<WeiDataType,
            //                 BF16> &&
            //                              is_same_v<OutDataType, BF16> && is_same_v<ComputeTypeA,
            //                              BF16> && is_same_v<ComputeTypeB, BF16>)
            //                 {
...
//         }
        ...
        if constexpr(NumDimSpatial == 2)
        {
            ...
            //                 if constexpr(is_same_v<InDataType, int8_t> && is_same_v<WeiDataType,
            //                 int8_t> &&
