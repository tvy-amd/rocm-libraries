...
//         }
        ...
        //             {
        // #ifdef CK_ENABLE_FP32
        //                 if constexpr(is_same_v<InDataType, float> && is_same_v<WeiDataType,
        //                 float> &&
        //                              is_same_v<OutDataType, float> && is_same_v<ComputeTypeA,
        //                              float> && is_same_v<ComputeTypeB, float>)
        //                 {
        //                     add_device_grouped_conv1d_bwd_weight_xdl_gnwc_gkxc_gnwk_f32_instances(op_ptrs);
        //                 }
        // #endif
        // #ifdef CK_ENABLE_FP16
        //                 if constexpr(is_same_v<InDataType, half_t> && is_same_v<WeiDataType,
        //                 half_t> &&
        //                              is_same_v<OutDataType, half_t> && is_same_v<ComputeTypeA,
        //                              half_t> && is_same_v<ComputeTypeB, half_t>)
        //                 {
        //                     add_device_grouped_conv1d_bwd_weight_xdl_gnwc_gkxc_gnwk_f16_instances(op_ptrs);
        //                 }
        // #endif
        // #ifdef CK_ENABLE_BF16
        //                 if constexpr(is_same_v<InDataType, ck::bhalf_t> && is_same_v<WeiDataType,
        //                 float> &&
        //                              is_same_v<OutDataType, ck::bhalf_t> &&
        //                              is_same_v<ComputeTypeA, ck::bhalf_t> &&
        //                              is_same_v<ComputeTypeB, ck::bhalf_t>)
                         ...
                         is_same_v<OutLayout, NHWGK>)
            {
                             ...
                             is_same_v<ComputeTypeB, half_t>)
                {
                    ...
                    add_device_grouped_conv2d_bwd_weight_xdl_nhwgc_gkyxc_nhwgk_f16_wavelet_pad0_instances(
                        op_ptrs);
                    add_device_grouped_conv2d_bwd_weight_xdl_nhwgc_gkyxc_nhwgk_f16_wavelet_4w2_default_instances(
                        op_ptrs);
                    add_device_grouped_conv2d_bwd_weight_xdl_nhwgc_gkyxc_nhwgk_f16_wavelet_4w2_pad0_instances(
                        op_ptrs);
                             ...
                             is_same_v<ComputeTypeB, ck::bhalf_t>)
                {
                    ...
                    add_device_grouped_conv2d_bwd_weight_xdl_nhwgc_gkyxc_nhwgk_bf16_wavelet_pad0_instances(
                        op_ptrs);
                    add_device_grouped_conv2d_bwd_weight_xdl_nhwgc_gkyxc_nhwgk_bf16_wavelet_4w2_default_instances(
                        op_ptrs);
                    add_device_grouped_conv2d_bwd_weight_xdl_nhwgc_gkyxc_nhwgk_bf16_wavelet_4w2_pad0_instances(
                        op_ptrs);
