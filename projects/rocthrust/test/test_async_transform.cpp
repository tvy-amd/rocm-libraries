...
TESTS_DEFINE(AsyncTransformBuiltinNumericTypesTests, BuiltinNumericTypes);
...
template <typename T,
          ...
          template <typename>
          class UnaryOperation>
void test_async_transform_unary_counting_iterator()
{
...
TYPED_TEST(AsyncTransformBuiltinNumericTypesTests, test_async_transform_unary_counting_iterator_divide_by_2)
{
  SCOPED_TRACE(testing::Message() << "with device_id= " << test::set_device_from_ctest());
  using T = typename TestFixture::input_type;
...
TYPED_TEST(AsyncTransformBuiltinNumericTypesTests, test_async_transform_unary_counting_iterator_policy_divide_by_2)
{
  SCOPED_TRACE(testing::Message() << "with device_id= " << test::set_device_from_ctest());
  using T = typename TestFixture::input_type;
  test_async_transform_unary_counting_iterator<T,
...
void test_async_transform_using()
{
  for (auto size : get_sizes())
  {
    SCOPED_TRACE(testing::Message() << "with size = " << size);
