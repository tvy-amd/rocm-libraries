...
{
  template <typename DerivedPolicy, typename ForwardIt, typename Sentinel, typename T, typename BinaryOp>
  THRUST_HOST THRUST_SUPPRESS_DEPRECATED_PUSH static auto
  call(thrust::detail::execution_policy_base<DerivedPolicy> const& exec,
    ...
    THRUST_HOST THRUST_SUPPRESS_DEPRECATED_PUSH
    ...
    THRUST_RETURNS(async_reduce(
      ...
      THRUST_FWD(last),
      THRUST_FWD(init),
      thrust::plus<remove_cvref_t<T>>{})) THRUST_SUPPRESS_DEPRECATED_POP
...
struct reduce_into_fn final
{
  ...
  call(thrust::detail::execution_policy_base<DerivedPolicy> const& exec,
    ...
    THRUST_HOST THRUST_SUPPRESS_DEPRECATED_PUSH static auto call5(
