...
THRUST_HOST_DEVICE void shuffle(RandomIterator first, RandomIterator last, URBG&& g)
{
...
THRUST_HOST_DEVICE void shuffle_copy(RandomIterator first, RandomIterator last, OutputIterator result, URBG&& g)
{
  using thrust::system::detail::generic::select_system;
