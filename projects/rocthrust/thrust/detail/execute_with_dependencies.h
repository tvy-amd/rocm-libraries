...
public:
  ...
  THRUST_HOST execute_with_dependencies(super_t const& super, UDependencies&&... deps)
      : super_t(super)
      , dependencies(THRUST_FWD(deps)...)
  {}

  template <typename... UDependencies>
  THRUST_HOST execute_with_dependencies(UDependencies&&... deps)
      : dependencies(THRUST_FWD(deps)...)
  {}

  template <typename... UDependencies>
  THRUST_HOST execute_with_dependencies(super_t const& super, std::tuple<UDependencies...>&& deps)
      : super_t(super)
      , dependencies(std::move(deps))
  {}

  template <typename... UDependencies>
  THRUST_HOST execute_with_dependencies(std::tuple<UDependencies...>&& deps)
      : dependencies(std::move(deps))
  {}
  ...
  // Rebinding.
  template <typename... UDependencies>
  THRUST_HOST execute_with_dependencies<BaseSystem, UDependencies...>
...
public:
  template <typename... UDependencies>
  THRUST_HOST execute_with_allocator_and_dependencies(super_t const& super, Allocator a, UDependencies&&... deps)
      : super_t(super)
      , dependencies(THRUST_FWD(deps)...)
      , alloc(a)
  {}
  ...
  template <typename... UDependencies>
  THRUST_HOST execute_with_allocator_and_dependencies(Allocator a, UDependencies&&... deps)
      : dependencies(THRUST_FWD(deps)...)
      , alloc(a)
  {}
  ...
  template <typename... UDependencies>
  THRUST_HOST execute_with_allocator_and_dependencies(Allocator a, std::tuple<UDependencies...>&& deps)
      : dependencies(std::move(deps))
      , alloc(a)
  {}
  ...
  THRUST_HOST typename std::add_lvalue_reference<Allocator>::type get_allocator()
  {
    return alloc;
  }
  ...
  // Rebinding.
  template <typename... UDependencies>
  THRUST_HOST execute_with_allocator_and_dependencies<Allocator, BaseSystem, UDependencies...>
  rebind_after(UDependencies&&... udependencies) const
  {
...
template <template <typename> class BaseSystem, typename... Dependencies>
THRUST_HOST std::tuple<::internal::remove_cvref_t<Dependencies>...>
...
template <typename Allocator, template <typename> class BaseSystem, typename... Dependencies>
THRUST_HOST std::tuple<::internal::remove_cvref_t<Dependencies>...> extract_dependencies(
