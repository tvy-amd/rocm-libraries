...
public:
  ...
  THRUST_HOST_DEVICE inline tagged_allocator();

  THRUST_HOST_DEVICE inline tagged_allocator(const tagged_allocator&);

  template <typename U, typename OtherPointer>
  THRUST_HOST_DEVICE inline tagged_allocator(const tagged_allocator<U, Tag, OtherPointer>&);

  THRUST_HOST_DEVICE inline ~tagged_allocator();

  THRUST_HOST_DEVICE pointer address(reference x) const;

  THRUST_HOST_DEVICE const_pointer address(const_reference x) const;
