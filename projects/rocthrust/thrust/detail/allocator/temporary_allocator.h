...
public:
  ...
  inline THRUST_HOST_DEVICE temporary_allocator(const temporary_allocator& other)
      : super_t()
      , m_system(other.m_system)
  {}

  inline THRUST_HOST_DEVICE explicit temporary_allocator(thrust::execution_policy<System>& system)
      : super_t()
