...
struct cons
{
  ...
  struct static_get
  {
    static const unsigned int value =
      (key == Head::key) ? (Head::value) : Tail::template static_get<key, default_value>::value;
  };

  template <unsigned int default_value>
  THRUST_HOST_DEVICE static unsigned int get(unsigned int key)
  {
...
template <unsigned int default_value,
          ...
          unsigned int key1   = 0,
          unsigned int value1 = default_value,
          unsigned int key2   = 0,
          unsigned int value2 = default_value,
          unsigned int key3   = 0,
          unsigned int value3 = default_value,
          unsigned int key4   = 0,
          unsigned int value4 = default_value,
          unsigned int key5   = 0,
          unsigned int value5 = default_value,
          unsigned int key6   = 0,
          unsigned int value6 = default_value,
          unsigned int key7   = 0,
...
THRUST_HOST_DEVICE unsigned int lookup(unsigned int key)
{
