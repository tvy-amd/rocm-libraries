...
public:
  ...
  THRUST_HOST_DEVICE discard_iterator(incrementable const& i = incrementable())
...
template <typename System = use_default>
inline THRUST_HOST_DEVICE discard_iterator<System>
make_discard_iterator(typename discard_iterator<System>::difference_type i = 0)
{
