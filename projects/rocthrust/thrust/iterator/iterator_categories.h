...
struct input_device_iterator_tag
    : detail::iterator_category_with_system_and_traversal<_THRUST_STD::input_iterator_tag,
                                                          device_system_tag,
...
struct output_device_iterator_tag
    : detail::iterator_category_with_system_and_traversal<_THRUST_STD::output_iterator_tag,
                                                          device_system_tag,
                                                          single_pass_traversal_tag>
{};
...
struct forward_device_iterator_tag
    : detail::iterator_category_with_system_and_traversal<_THRUST_STD::forward_iterator_tag,
                                                          device_system_tag,
...
struct bidirectional_device_iterator_tag
    : detail::iterator_category_with_system_and_traversal<_THRUST_STD::bidirectional_iterator_tag,
                                                          device_system_tag,
...
struct random_access_device_iterator_tag
    : detail::iterator_category_with_system_and_traversal<_THRUST_STD::random_access_iterator_tag,
                                                          device_system_tag,
 ...
 *  bidirectional_host_iterator_tag, random_access_host_iterator_tag
 */
using input_host_iterator_tag = _THRUST_STD::input_iterator_tag;
 ...
 *  bidirectional_host_iterator_tag, random_access_host_iterator_tag
 */
using output_host_iterator_tag = _THRUST_STD::output_iterator_tag;
 ...
 *  bidirectional_host_iterator_tag, random_access_host_iterator_tag
 */
using forward_host_iterator_tag = _THRUST_STD::forward_iterator_tag;
 ...
 */
using bidirectional_host_iterator_tag = _THRUST_STD::bidirectional_iterator_tag;
 ...
 */
using random_access_host_iterator_tag = _THRUST_STD::random_access_iterator_tag;
