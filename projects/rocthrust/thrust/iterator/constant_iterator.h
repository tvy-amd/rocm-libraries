...
{
  using incrementable = typename ia_dflt_help<Incrementable, identity_<_THRUST_STD::intmax_t>>::type;
...
protected:
  THRUST_HOST_DEVICE Value const& value_reference() const
  {
    return m_value;
  }

  THRUST_HOST_DEVICE Value& value_reference()
  {
    return m_value;
  }
