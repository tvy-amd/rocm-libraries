...
struct enable_if_bool_sort
    : _THRUST_STD::enable_if<_THRUST_STD::is_same<bool, thrust::detail::it_value_t<Iterator>>::value>
{};

template <typename Iterator>
struct disable_if_bool_sort
    : thrust::detail::disable_if<_THRUST_STD::is_same<bool, thrust::detail::it_value_t<Iterator>>::value>
{};

template <typename DerivedPolicy, typename RandomAccessIterator>
typename enable_if_bool_sort<RandomAccessIterator>::type THRUST_HOST_DEVICE stable_primitive_sort(
...
template <typename DerivedPolicy, typename RandomAccessIterator>
typename disable_if_bool_sort<RandomAccessIterator>::type THRUST_HOST_DEVICE stable_primitive_sort(
  sequential::execution_policy<DerivedPolicy>& exec, RandomAccessIterator first, RandomAccessIterator last)
{
...
struct logical_not_first
{
  ...
  THRUST_HOST_DEVICE bool operator()(Tuple t)
  {
...
typename enable_if_bool_sort<RandomAccessIterator1>::type THRUST_HOST_DEVICE stable_primitive_sort_by_key(
...
template <typename DerivedPolicy, typename RandomAccessIterator1, typename RandomAccessIterator2>
typename disable_if_bool_sort<RandomAccessIterator1>::type THRUST_HOST_DEVICE stable_primitive_sort_by_key(
  sequential::execution_policy<DerivedPolicy>& exec,
  RandomAccessIterator1 keys_first,
  RandomAccessIterator1 keys_last,
  RandomAccessIterator2 values_first)
...
template <typename DerivedPolicy, typename RandomAccessIterator>
THRUST_HOST_DEVICE void stable_primitive_sort(
  sequential::execution_policy<DerivedPolicy>& exec, RandomAccessIterator first, RandomAccessIterator last)
{
...
template <typename DerivedPolicy, typename RandomAccessIterator1, typename RandomAccessIterator2>
THRUST_HOST_DEVICE void stable_primitive_sort_by_key(
  sequential::execution_policy<DerivedPolicy>& exec,
  RandomAccessIterator1 keys_first,
  RandomAccessIterator1 keys_last,
  RandomAccessIterator2 values_first)
