...
struct reference_is_assignable
{
  ...
  {
    if constexpr (_THRUST_STD::is_same_v<thrust::detail::it_reference_t<OI>, void>)
    {
      return true;
    }
    else
    {
      return _THRUST_STD::is_assignable_v<thrust::detail::it_reference_t<OI>,
