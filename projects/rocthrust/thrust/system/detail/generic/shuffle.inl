...
{
  THRUST_HOST_DEVICE key_flag_tuple operator()(const key_flag_tuple& a, const key_flag_tuple& b)
  {
...
struct construct_key_flag_op
{
  ...
  THRUST_HOST_DEVICE construct_key_flag_op(std::uint64_t m, feistel_bijection bijection)
      : m(m)
      , bijection(bijection)
  {}
