...
struct min_element_reduction
{
  ...
  THRUST_HOST_DEVICE min_element_reduction(BinaryPredicate comp)
      : comp(comp)
  {}

  THRUST_HOST_DEVICE thrust::tuple<InputType, IndexType>
...
struct max_element_reduction
{
  ...
  THRUST_HOST_DEVICE max_element_reduction(BinaryPredicate comp)
      : comp(comp)
  {}
...
struct minmax_element_reduction
{
  ...
  THRUST_HOST_DEVICE minmax_element_reduction(BinaryPredicate comp)
      : comp(comp)
  {}

  THRUST_HOST_DEVICE thrust::tuple<thrust::tuple<InputType, IndexType>, thrust::tuple<InputType, IndexType>>
