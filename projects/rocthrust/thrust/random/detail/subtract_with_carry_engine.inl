...
THRUST_HOST_DEVICE subtract_with_carry_engine<UIntType, w, s, r>::subtract_with_carry_engine(result_type value)
{
  seed(value);
} // end subtract_with_carry_engine::subtract_with_carry_engine()

template <typename UIntType, size_t w, size_t s, size_t r>
THRUST_HOST_DEVICE void subtract_with_carry_engine<UIntType, w, s, r>::seed(result_type value)
{
...
template <typename UIntType, size_t w, size_t s, size_t r>
THRUST_HOST_DEVICE typename subtract_with_carry_engine<UIntType, w, s, r>::result_type
...
template <typename UIntType, size_t w, size_t s, size_t r>
THRUST_HOST_DEVICE void subtract_with_carry_engine<UIntType, w, s, r>::discard(unsigned long long z)
{
  for (; z > 0; --z)
  {
    this->operator()();
...
template <typename UIntType, size_t w, size_t s, size_t r>
THRUST_HOST_DEVICE bool operator==(const subtract_with_carry_engine<UIntType, w, s, r>& lhs,
