...
THRUST_HOST_DEVICE discard_block_engine<Engine, p, r>::discard_block_engine()
    : m_e()
    , m_n(0)
{}

template <typename Engine, size_t p, size_t r>
THRUST_HOST_DEVICE discard_block_engine<Engine, p, r>::discard_block_engine(result_type s)
    : m_e(s)
    , m_n(0)
{}

template <typename Engine, size_t p, size_t r>
THRUST_HOST_DEVICE discard_block_engine<Engine, p, r>::discard_block_engine(const base_type& urng)
    : m_e(urng)
    , m_n(0)
{}

template <typename Engine, size_t p, size_t r>
THRUST_HOST_DEVICE void discard_block_engine<Engine, p, r>::seed()
{
  m_e.seed();
  m_n = 0;
}
...
template <typename Engine, size_t p, size_t r>
THRUST_HOST_DEVICE void discard_block_engine<Engine, p, r>::seed(result_type s)
{
  m_e.seed(s);
  m_n = 0;
}
...
template <typename Engine, size_t p, size_t r>
THRUST_HOST_DEVICE typename discard_block_engine<Engine, p, r>::result_type
...
template <typename Engine, size_t p, size_t r>
THRUST_HOST_DEVICE void discard_block_engine<Engine, p, r>::discard(unsigned long long z)
{
...
template <typename Engine, size_t p, size_t r>
THRUST_HOST_DEVICE const typename discard_block_engine<Engine, p, r>::base_type&
...
template <typename Engine, size_t p, size_t r>
THRUST_HOST_DEVICE bool discard_block_engine<Engine, p, r>::equal(const discard_block_engine<Engine, p, r>& rhs) const
{
