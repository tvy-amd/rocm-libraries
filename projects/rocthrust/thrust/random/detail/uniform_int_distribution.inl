...
THRUST_HOST_DEVICE uniform_int_distribution<IntType>::uniform_int_distribution(IntType a, IntType b)
    : m_param(a, b)
{} // end uniform_int_distribution::uniform_int_distribution()

template <typename IntType>
THRUST_HOST_DEVICE uniform_int_distribution<IntType>::uniform_int_distribution(const param_type& parm)
    : m_param(parm)
{} // end uniform_int_distribution::uniform_int_distribution()

template <typename IntType>
THRUST_HOST_DEVICE void uniform_int_distribution<IntType>::reset()
{} // end uniform_int_distribution::reset()

template <typename IntType>
template <typename UniformRandomNumberGenerator>
THRUST_HOST_DEVICE typename uniform_int_distribution<IntType>::result_type
...
template <typename IntType>
THRUST_HOST_DEVICE typename uniform_int_distribution<IntType>::result_type uniform_int_distribution<IntType>::a() const
{
  return m_param.first;
} // end uniform_int_distribution<IntType>::a()

template <typename IntType>
THRUST_HOST_DEVICE typename uniform_int_distribution<IntType>::result_type uniform_int_distribution<IntType>::b() const
{
  return m_param.second;
} // end uniform_int_distribution::b()

template <typename IntType>
THRUST_HOST_DEVICE typename uniform_int_distribution<IntType>::param_type uniform_int_distribution<IntType>::param() const
{
  return m_param;
} // end uniform_int_distribution::param()

template <typename IntType>
THRUST_HOST_DEVICE void uniform_int_distribution<IntType>::param(const param_type& parm)
{
  m_param = parm;
} // end uniform_int_distribution::param()

template <typename IntType>
THRUST_HOST_DEVICE typename uniform_int_distribution<IntType>::result_type uniform_int_distribution<IntType>::min
...
template <typename IntType>
THRUST_HOST_DEVICE typename uniform_int_distribution<IntType>::result_type uniform_int_distribution<IntType>::max
THRUST_PREVENT_MACRO_SUBSTITUTION() const
{
  return b();
...
template <typename IntType>
THRUST_HOST_DEVICE bool uniform_int_distribution<IntType>::equal(const uniform_int_distribution& rhs) const
{
