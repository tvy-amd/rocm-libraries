...
THRUST_HOST_DEVICE linear_congruential_engine<UIntType, a, c, m>::linear_congruential_engine(result_type s)
{
  seed(s);
} // end linear_congruential_engine::linear_congruential_engine()

template <typename UIntType, UIntType a, UIntType c, UIntType m>
THRUST_HOST_DEVICE void linear_congruential_engine<UIntType, a, c, m>::seed(result_type s)
{
...
template <typename UIntType, UIntType a, UIntType c, UIntType m>
THRUST_HOST_DEVICE typename linear_congruential_engine<UIntType, a, c, m>::result_type
...
template <typename UIntType, UIntType a, UIntType c, UIntType m>
THRUST_HOST_DEVICE void linear_congruential_engine<UIntType, a, c, m>::discard(unsigned long long z)
{
...
template <typename UIntType, UIntType a, UIntType c, UIntType m>
THRUST_HOST_DEVICE bool operator!=(const linear_congruential_engine<UIntType, a, c, m>& lhs,
