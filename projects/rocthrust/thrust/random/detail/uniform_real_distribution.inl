...
THRUST_HOST_DEVICE uniform_real_distribution<RealType>::uniform_real_distribution(RealType a, RealType b)
    : m_param(a, b)
{} // end uniform_real_distribution::uniform_real_distribution()

template <typename RealType>
THRUST_HOST_DEVICE uniform_real_distribution<RealType>::uniform_real_distribution(const param_type& parm)
    : m_param(parm)
{} // end uniform_real_distribution::uniform_real_distribution()

template <typename RealType>
THRUST_HOST_DEVICE void uniform_real_distribution<RealType>::reset()
{} // end uniform_real_distribution::reset()

template <typename RealType>
template <typename UniformRandomNumberGenerator>
THRUST_HOST_DEVICE typename uniform_real_distribution<RealType>::result_type
...
template <typename RealType>
THRUST_HOST_DEVICE typename uniform_real_distribution<RealType>::param_type
...
template <typename RealType>
THRUST_HOST_DEVICE void uniform_real_distribution<RealType>::param(const param_type& parm)
{
  m_param = parm;
} // end uniform_real_distribution::param()

template <typename RealType>
THRUST_HOST_DEVICE typename uniform_real_distribution<RealType>::result_type uniform_real_distribution<RealType>::min
...
template <typename RealType>
THRUST_HOST_DEVICE typename uniform_real_distribution<RealType>::result_type uniform_real_distribution<RealType>::max
THRUST_PREVENT_MACRO_SUBSTITUTION() const
{
  return b();
...
template <typename RealType>
THRUST_HOST_DEVICE bool uniform_real_distribution<RealType>::equal(const uniform_real_distribution& rhs) const
{
