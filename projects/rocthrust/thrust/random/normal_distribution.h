...
public:
   ...
   */
  THRUST_HOST_DEVICE explicit normal_distribution(RealType mean = 0.0, RealType stddev = 1.0);
   ...
   * distribution.
   */
  THRUST_HOST_DEVICE explicit normal_distribution(const param_type& parm);
  ...
  THRUST_HOST_DEVICE result_type operator()(UniformRandomNumberGenerator& urng);
   ...
   */
  template <typename UniformRandomNumberGenerator>
  THRUST_HOST_DEVICE result_type operator()(UniformRandomNumberGenerator& urng, const param_type& parm);
   ...
   */
  THRUST_HOST_DEVICE result_type mean() const;
   ...
   */
  THRUST_HOST_DEVICE result_type stddev() const;
   ...
   * normal_distribution.
   */
  THRUST_HOST_DEVICE void param(const param_type& parm);
...
private:
  ...
  THRUST_HOST_DEVICE bool equal(const normal_distribution& rhs) const;
