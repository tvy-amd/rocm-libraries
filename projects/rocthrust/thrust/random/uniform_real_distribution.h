...
public:
   ...
   * \c 1.0.
   */
  THRUST_HOST_DEVICE explicit uniform_real_distribution(RealType a = 0.0, RealType b = 1.0);
   ...
   */
  THRUST_HOST_DEVICE explicit uniform_real_distribution(const param_type& parm);
...
private:
  ...
  THRUST_HOST_DEVICE bool equal(const uniform_real_distribution& rhs) const;
