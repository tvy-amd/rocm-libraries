...
TEST(TestGraphMoeGroupedMatmul, BuildGraph)
{
    ...
    // Call graph method
    auto output = graph.moe_grouped_matmul(token, weight, firstTokenOffset, tokenIndex, tokenKs, attributes);
