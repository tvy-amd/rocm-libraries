...
TYPED_TEST(LayernormBpropPlanTyped, ExecutePlanWithRuntimeEpsilonFromPack)
{
    ...
    *static_cast<float*>(
    ...
    LayernormBpropPlan<YType, ScaleType, YType, XType, float> runtimePlan(std::move(runtimeParams));
    ...
    LayernormBpropPlan<YType, ScaleType, YType, XType, float> bakedPlan(std::move(bakedParams));
