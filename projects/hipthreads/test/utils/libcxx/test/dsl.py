...
def _executeWithFakeConfig(test, commands):
    ...
    import inspect
    sig = inspect.signature(lit.LitConfig.LitConfig.__init__)
    if 'diagnostic_level' in sig.parameters:
        litConfig_kwargs['diagnostic_level'] = 'note'
    else:
        litConfig_kwargs['quiet'] = False
    litConfig = lit.LitConfig.LitConfig(**litConfig_kwargs)
