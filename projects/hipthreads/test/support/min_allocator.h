...
public:
    ...
    __host__ __device__ friend bool operator==(bare_allocator, bare_allocator) {return true;}
    __host__ __device__ friend bool operator!=(bare_allocator x, bare_allocator y) {return !(x == y);}
};
...
{
#if TEST_STD_VER >= 11
    __host__ __device__ no_default_allocator() = delete;
#else
    __host__ __device__ no_default_allocator();
#endif
...
public:
    ...
    __host__ __device__ friend bool operator==(no_default_allocator, no_default_allocator) {return true;}
    __host__ __device__ friend bool operator!=(no_default_allocator x, no_default_allocator y) {return !(x == y);}
};
...
public:
    ...
    __host__ __device__ malloc_allocator() TEST_NOEXCEPT { assert(!disable_default_constructor); }
    ...
    __host__ __device__ friend bool operator!=(malloc_allocator x, malloc_allocator y) {return !(x == y);}
};
...
public:
    ...
    __host__ __device__ friend bool operator==(min_pointer x, min_pointer y) {return x.ptr_ == y.ptr_;}
    __host__ __device__ friend bool operator!=(min_pointer x, min_pointer y) {return !(x == y);}
...
public:
    ...
    __host__ __device__ TEST_CONSTEXPR_CXX14 friend bool operator==(min_pointer x, min_pointer y) {return x.ptr_ == y.ptr_;}
    __host__ __device__ TEST_CONSTEXPR_CXX14 friend bool operator!=(min_pointer x, min_pointer y) {return !(x == y);}
    template <class U, class XID> friend class min_pointer;
};
...
public:
    ...
    __host__ __device__ TEST_CONSTEXPR_CXX14 min_pointer& operator++() {++ptr_; return *this;}
    __host__ __device__ TEST_CONSTEXPR_CXX14 min_pointer operator++(int) {min_pointer tmp(*this); ++ptr_; return tmp;}

    __host__ __device__ TEST_CONSTEXPR_CXX14 min_pointer& operator--() {--ptr_; return *this;}
    __host__ __device__ TEST_CONSTEXPR_CXX14 min_pointer operator--(int) {min_pointer tmp(*this); --ptr_; return tmp;}

    __host__ __device__ TEST_CONSTEXPR_CXX14 min_pointer& operator+=(difference_type n) {ptr_ += n; return *this;}
    __host__ __device__ TEST_CONSTEXPR_CXX14 min_pointer& operator-=(difference_type n) {ptr_ -= n; return *this;}

    __host__ __device__ TEST_CONSTEXPR_CXX14 min_pointer operator+(difference_type n) const
    {
    ...
    __host__ __device__ friend TEST_CONSTEXPR_CXX14 min_pointer operator+(difference_type n, min_pointer x)
    {
        return x + n;
    }
    ...
    __host__ __device__ friend TEST_CONSTEXPR_CXX14 difference_type operator-(min_pointer x, min_pointer y)
    {
        return x.ptr_ - y.ptr_;
    }

    __host__ __device__ TEST_CONSTEXPR_CXX14 reference operator[](difference_type n) const {return ptr_[n];}
...
public:
    ...
    __host__ __device__ min_allocator() = default;
    template <class U>
    ...
    __host__ __device__ TEST_CONSTEXPR_CXX20 friend bool operator!=(min_allocator x, min_allocator y) {return !(x == y);}
};
...
public:
    ...
    __host__ __device__ TEST_CONSTEXPR_CXX20 explicit_allocator() TEST_NOEXCEPT {}
    ...
    __host__ __device__ TEST_CONSTEXPR_CXX20 friend bool operator!=(explicit_allocator x, explicit_allocator y) {return !(x == y);}
};
...
public:
  ...
  __host__ __device__ TEST_CONSTEXPR_CXX20 unaligned_allocator() TEST_NOEXCEPT {}
...
public:
  ...
  __host__ __device__ TEST_CONSTEXPR_CXX20 safe_allocator() TEST_NOEXCEPT {}
  ...
  __host__ __device__ TEST_CONSTEXPR_CXX20 friend bool operator!=(safe_allocator x, safe_allocator y) { return !(x == y); }
};
