...
class hittable_list  {
    public:
        __host__ __device__ hittable_list(sphere **l, int n) { list = l; list_size = n; }
...
__host__ __device__ bool hittable_list::hit(const ray& r, float t_min, float t_max, hit_record& rec) const {
    hit_record temp_rec;
